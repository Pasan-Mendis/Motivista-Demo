    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center mb-12 lg:mb-16">
          <div
            className={`inline-flex items-center gap-2 px-4 py-2 rounded-full border mb-6 transition-all duration-1000 ${
              isVisible
          ...
          <h2
            className={`text-3xl sm:text-4xl lg:text-5xl xl:text-6xl font-black mb-6 transition-all duration-1000 delay-200 ${
          ...
          <p
            className={`text-lg md:text-xl max-w-3xl mx-auto leading-relaxed transition-all duration-1000 delay-400 ${
              isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"
            }`}
            style={{ color: "var(--color-gray-600)" }}
          >
            Explore our recent work showcasing creativity, precision, and flawless
            execution across diverse event categories.
          </p>
        </div>
            ...
            >
              ...
              >
                ...
                <div
                  ...
                  style={{
                    background:
                      "linear-gradient(180deg, rgba(10, 9, 3, 0) 0%, rgba(10, 9, 3, 0.3) 40%, rgba(10, 9, 3, 0.9) 100%)",
        ...
        >
          <div className="relative inline-block w-full sm:w-auto px-4">
            <div
              className="absolute -inset-2 sm:-inset-4 rounded-3xl opacity-5"
            ...
            <Link
              ...
              px-6 sm:px-10 py-3 sm:py-5 mx-auto w-[90%] sm:w-auto 
          ...
          <p
            className="mt-4 sm:mt-6 text-xs sm:text-sm px-4 sm:px-0 leading-relaxed"
            style={{ color: "var(--color-gray-600)" }}
          >
            View our complete collection of{" "}
